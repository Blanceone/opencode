...
export const dict = {
  ...
  "command.wiki.open.description": "Generate or update the project .wiki knowledge base",

  "dialog.openwiki.title": "OpenWiki",
  "dialog.openwiki.description": "Uses the model currently selected in OpenCode",
  ...
  "page.openwiki.files.title": "Wiki files",
  "page.openwiki.files.description": "Browse generated pages under .wiki",
  "page.openwiki.files.notGenerated": "Generate a wiki to browse .wiki files here.",
  "page.openwiki.files.empty": "The .wiki folder exists but has no files yet.",
  "page.openwiki.files.emptyFile": "This file is empty.",
  "page.openwiki.files.selectTitle": "Select a wiki file",
  "page.openwiki.files.selectDescription": "Choose a file from the tree to preview it here.",
  "dialog.openwiki.workspace": "Workspace",
  "dialog.openwiki.wikiPath": "Wiki path",
  "dialog.openwiki.root": "Root",
  "dialog.openwiki.model": "Model",
  "dialog.openwiki.model.followCurrent": "OpenCode current model",
  "dialog.openwiki.exists": "Wiki status",
  "dialog.openwiki.exists.yes": "Ready",
  "dialog.openwiki.exists.no": "Not created yet",
  "dialog.openwiki.exists.hint": "Whether .wiki already has content OpenCode can use for @wiki.",
  "dialog.openwiki.ownership": "Ownership",
  "dialog.openwiki.ownership.hint": "Who owns .wiki. Foreign or conflict requires consent before OpenCode can manage it.",
  "dialog.openwiki.ownership.absent": "None",
  "dialog.openwiki.ownership.opencode-managed": "Managed by OpenCode",
  "dialog.openwiki.ownership.foreign": "Existing (needs consent)",
  "dialog.openwiki.ownership.conflict": "Conflict (needs consent)",
  "dialog.openwiki.login": "Login ready",
  "dialog.openwiki.job": "Job",
  "dialog.openwiki.job.idle": "Idle",
  "dialog.openwiki.job.queued": "Queued",
  "dialog.openwiki.job.preparing": "Preparing",
  "dialog.openwiki.job.mapping-model": "Mapping model",
  "dialog.openwiki.job.running": "Generating",
  "dialog.openwiki.job.writing": "Writing files",
  "dialog.openwiki.job.completed": "Completed",
  "dialog.openwiki.job.failed": "Failed",
  "dialog.openwiki.job.cancelled": "Cancelled",
  "dialog.openwiki.driveRootWarning": "This workspace looks like a drive root. Open a project folder before generating.",
  "dialog.openwiki.yes": "yes",
  "dialog.openwiki.no": "no",
  "dialog.openwiki.action.generate": "Generate",
  "dialog.openwiki.action.generating": "Generating…",
  "dialog.openwiki.action.update": "Update",
  "dialog.openwiki.action.updating": "Updating…",
  "dialog.openwiki.action.refresh": "Refresh",
  "dialog.openwiki.consent.prompt": "Existing wiki content requires consent before OpenCode can manage it.",
  "dialog.openwiki.consent.foreignPaths": "Paths",
  "dialog.openwiki.consent.adopt": "Adopt existing",
  "dialog.openwiki.consent.backupRebuild": "Backup and rebuild",
  "dialog.openwiki.format.show": "Edit format",
  ...
  "dialog.openwiki.format.reset": "Reset to defaults",
  "dialog.openwiki.format.reset.confirm": "Replace the active instructions and FORMAT.md with the built-in defaults?",
  "dialog.openwiki.tip.references": "Generate also writes references.wiki -> ./.wiki into opencode.json for @wiki mentions.",
  "dialog.openwiki.action.exportDocx": "Export Word",
  "dialog.openwiki.export.preparing": "Preparing Word export…",
  "dialog.openwiki.export.done": "Downloaded {{count}} Word file(s).",
  "dialog.openwiki.export.empty": "No wiki pages available to export.",
  "dialog.openwiki.references.title": "Reference documents",
  "dialog.openwiki.references.typeHint": "Accepted types: .md, .doc, .docx. Prefer text-only docs; describe diagrams in code rather than embedding images.",
  "dialog.openwiki.references.limitHint": "Up to 10 files. Files over 10MB ask for confirmation; files over 50MB are rejected.",
  "dialog.openwiki.references.import": "Import files",
  "dialog.openwiki.references.empty": "No reference documents imported yet.",
  "dialog.openwiki.references.remove": "Remove",
  "dialog.openwiki.references.confirmLarge": "One or more files are larger than 10MB. Continue importing?",
  "dialog.openwiki.references.imported": "Imported {{count}} reference document(s).",
  "dialog.openwiki.parse.title": "Parse into draft",
  "dialog.openwiki.parse.info": "Parse builds a draft brief/format from reference documents without changing active prompts until you merge.",
  "dialog.openwiki.parse.action": "Parse references",
  "dialog.openwiki.parse.parsing": "Parsing…",
  "dialog.openwiki.merge.action": "Merge draft",
  "dialog.openwiki.merge.done": "Draft merged into active prompts.",
  "dialog.openwiki.draft.title": "Parsed draft",
  "dialog.openwiki.draft.instructions": "Draft instructions",
  "dialog.openwiki.draft.format": "Draft format",
  "dialog.openwiki.draft.empty": "No draft yet. Parse reference documents to create one.",
  "dialog.openwiki.draft.warnings": "Warnings",
  "dialog.openwiki.error.modelRequired": "Select a model in OpenCode first.",
  "dialog.openwiki.error.consentRequired": "Consent is required before generating or editing this wiki.",
  ...
  "dialog.openwiki.error.rateLimit": "Model rate limit reached. Wait a moment, then try Generate or Update again—or switch to another model.",
