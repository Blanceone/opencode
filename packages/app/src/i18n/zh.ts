...
export const dict = {
  ...
  "page.openwiki.description": "生成并管理项目 .wiki 知识库。使用 OpenCode 当前选中的模型。",
  "page.openwiki.back": "返回会话",
  "dialog.openwiki.backWithActiveJob": "Wiki 生成任务正在运行中，返回将终止该任务。确认继续？",
  "page.openwiki.status.title": "状态",
  "page.openwiki.actions.title": "操作",
  "page.openwiki.format.hidden": "格式编辑器已隐藏。点击「显示格式」可编辑说明与 FORMAT.md。",
  "page.openwiki.files.title": "Wiki 文件",
  "page.openwiki.files.description": "浏览 .wiki 目录下已生成的页面",
  "page.openwiki.files.notGenerated": "生成 Wiki 后可在此浏览 .wiki 文件。",
  "page.openwiki.files.empty": ".wiki 目录已存在，但还没有文件。",
  "page.openwiki.files.emptyFile": "此文件为空。",
  "page.openwiki.files.selectTitle": "选择 Wiki 文件",
  "page.openwiki.files.selectDescription": "从左侧文件树中选择文件以预览。",
  "dialog.openwiki.workspace": "工作区",
  "dialog.openwiki.wikiPath": "Wiki 路径",
  "dialog.openwiki.root": "根目录",
  "dialog.openwiki.model": "模型",
  "dialog.openwiki.model.followCurrent": "OpenCode 当前模型",
  "dialog.openwiki.exists": "Wiki 状态",
  "dialog.openwiki.exists.yes": "已就绪",
  "dialog.openwiki.exists.no": "尚未创建",
  "dialog.openwiki.exists.hint": "表示项目下 .wiki 是否已有可供 @wiki 使用的内容。",
  "dialog.openwiki.ownership": "归属",
  "dialog.openwiki.ownership.hint": "表示 .wiki 由谁管理。外来或冲突内容需先同意后，OpenCode 才能接管。",
  "dialog.openwiki.ownership.absent": "无",
  "dialog.openwiki.ownership.opencode-managed": "由 OpenCode 管理",
  "dialog.openwiki.ownership.foreign": "已有内容（需同意）",
  "dialog.openwiki.ownership.conflict": "冲突（需同意）",
  "dialog.openwiki.login": "登录就绪",
  "dialog.openwiki.job": "任务",
  "dialog.openwiki.job.idle": "空闲",
  "dialog.openwiki.job.queued": "排队中",
  "dialog.openwiki.job.preparing": "准备中",
  "dialog.openwiki.job.mapping-model": "映射模型",
  "dialog.openwiki.job.running": "生成中",
  "dialog.openwiki.job.writing": "写入文件",
  "dialog.openwiki.job.completed": "已完成",
  "dialog.openwiki.job.failed": "失败",
  "dialog.openwiki.job.cancelled": "已取消",
  "dialog.openwiki.driveRootWarning": "当前工作区看起来是磁盘根目录。请先打开具体项目文件夹再生成。",
  "dialog.openwiki.yes": "是",
  "dialog.openwiki.no": "否",
  "dialog.openwiki.action.generate": "生成",
  "dialog.openwiki.action.generating": "生成中…",
  ...
  "dialog.openwiki.format.preset.openwiki-default": "默认",
  "dialog.openwiki.format.preset.architecture-module": "架构模块",
  "dialog.openwiki.format.preset.api-service": "API 服务",
  "dialog.openwiki.format.preset.custom": "自定义",
  "dialog.openwiki.format.instructions": "说明",
  "dialog.openwiki.format.body": "FORMAT.md",
  "dialog.openwiki.format.reset": "恢复默认",
  "dialog.openwiki.format.reset.confirm": "要用内置默认说明和 FORMAT.md 覆盖当前内容吗？",
  "dialog.openwiki.tip.references": "生成成功后会把 references.wiki -> ./.wiki 写入 opencode.json，便于 @wiki 引用。",
  "dialog.openwiki.action.exportDocx": "导出 Word",
  "dialog.openwiki.export.preparing": "正在准备 Word 导出…",
  "dialog.openwiki.export.done": "已下载 {{count}} 个 Word 文件。",
  "dialog.openwiki.export.empty": "没有可导出的 wiki 页面。",
  "dialog.openwiki.references.title": "参考文档",
  "dialog.openwiki.references.typeHint": "支持 .md / .doc / .docx。请优先纯文本文档；流程图请用代码描述，不要嵌入图片。",
  "dialog.openwiki.references.limitHint": "最多 10 个文件。超过 10MB 需确认；超过 50MB 会被拒绝。",
  "dialog.openwiki.references.import": "导入文件",
  "dialog.openwiki.references.empty": "尚未导入参考文档。",
  "dialog.openwiki.references.remove": "移除",
  "dialog.openwiki.references.confirmLarge": "有文件超过 10MB。是否继续导入？",
  "dialog.openwiki.references.imported": "已导入 {{count}} 个参考文档。",
  "dialog.openwiki.parse.title": "解析为草案",
  "dialog.openwiki.parse.info": "解析会根据参考文档生成草案说明/格式，合并前不会改动当前生效的提示词。",
  "dialog.openwiki.parse.action": "解析参考文档",
  "dialog.openwiki.parse.parsing": "解析中…",
  "dialog.openwiki.merge.action": "合并草案",
  "dialog.openwiki.merge.done": "草案已合并到当前提示词。",
  "dialog.openwiki.draft.title": "解析草案",
  "dialog.openwiki.draft.instructions": "草案说明",
  "dialog.openwiki.draft.format": "草案格式",
  "dialog.openwiki.draft.empty": "尚无草案。请先解析参考文档。",
  "dialog.openwiki.draft.warnings": "警告",
  ...
  "dialog.openwiki.error.rateLimit": "模型请求频率超限。请稍后再点生成或更新，或换一个模型。",
