...
export const dict = {
  ...
  "page.openwiki.files.title": "Wiki 檔案",
  "page.openwiki.files.description": "瀏覽 .wiki 目錄下已產生的頁面",
  "page.openwiki.files.notGenerated": "產生 Wiki 後可在此瀏覽 .wiki 檔案。",
  "page.openwiki.files.empty": ".wiki 目錄已存在，但還沒有檔案。",
  "page.openwiki.files.emptyFile": "此檔案為空。",
  "page.openwiki.files.selectTitle": "選擇 Wiki 檔案",
  "page.openwiki.files.selectDescription": "從左側檔案樹中選擇檔案以預覽。",
  ...
  "dialog.openwiki.format.show": "編輯格式",
  "dialog.openwiki.format.hide": "隱藏格式",
  "dialog.openwiki.format.title": "格式",
  "dialog.openwiki.format.preset": "預設",
  "dialog.openwiki.format.preset.openwiki-default": "預設",
  "dialog.openwiki.format.preset.architecture-module": "架構模組",
  "dialog.openwiki.format.preset.api-service": "API 服務",
  "dialog.openwiki.format.preset.custom": "自訂",
  "dialog.openwiki.format.instructions": "說明",
  "dialog.openwiki.format.body": "FORMAT.md",
  "dialog.openwiki.tip.references": "產生成功後會把 references.wiki -> ./.wiki 寫入 opencode.json，方便 @wiki 引用。",
  "dialog.openwiki.error.modelRequired": "請先在 OpenCode 中選擇模型。",
  "dialog.openwiki.error.consentRequired": "需要先同意後才能產生或編輯此 wiki。",
  "dialog.openwiki.error.noProviderLogin": "提供商 {{provider}} 尚未登入。",
  "dialog.openwiki.error.providerUnsupported": "提供商 {{provider}} 不支援 OpenWiki。",
  "dialog.openwiki.error.opencodeLoginRequired": "此 OpenCode 模型需要 Zen 登入，或改選可匿名使用的免費模型。",
  "dialog.openwiki.error.apiUnavailable": "OpenWiki 介面不可用。請更新後重新啟動應用程式，或確認本機服務已啟動。",
  "dialog.openwiki.error.nodeRequired": "OpenWiki 需要本機 Node.js（better-sqlite3）。請安裝 Node、設定 OPENWIKI_NODE_BINARY，或使用附帶 resources/openwiki/node 的安裝包。",
  "dialog.openwiki.error.packageMissing": "目前安裝缺少 OpenWiki 套件。請重新安裝應用程式，或重新執行 desktop prepare-openwiki。",
  "dialog.openwiki.error.workerMissing": "目前安裝缺少 OpenWiki worker。請重新安裝應用程式，或重新執行 desktop prepare-openwiki。",
  "dialog.openwiki.error.rateLimit": "模型請求頻率超限。請稍後再點產生或更新，或換一個模型。",
  "dialog.openwiki.confirm.regenerate": "已有 OpenCode 託管的 wiki。要再次產生並覆蓋嗎？",
  "dialog.openwiki.toast.completed.title": "OpenWiki 已就緒",
  "dialog.openwiki.toast.completed.description": "Wiki 產生已完成。",
  "dialog.openwiki.toast.failed.title": "OpenWiki 失敗",
  "dialog.openwiki.toast.failed.description": "{{message}}",
  "dialog.openwiki.workspace": "工作區",
  "dialog.openwiki.wikiPath": "Wiki 路徑",
  "dialog.openwiki.exists.yes": "已就緒",
  "dialog.openwiki.exists.no": "尚未建立",
  "dialog.openwiki.exists.hint": "表示專案下 .wiki 是否已有可供 @wiki 使用的內容。",
  "dialog.openwiki.ownership.hint": "表示 .wiki 由誰管理。外來或衝突內容需先同意後，OpenCode 才能接管。",
  "dialog.openwiki.ownership.absent": "無",
  "dialog.openwiki.ownership.opencode-managed": "由 OpenCode 管理",
  "dialog.openwiki.ownership.foreign": "既有內容（需同意）",
  "dialog.openwiki.ownership.conflict": "衝突（需同意）",
  "dialog.openwiki.job.idle": "閒置",
  "dialog.openwiki.job.queued": "排隊中",
  "dialog.openwiki.job.preparing": "準備中",
  "dialog.openwiki.job.mapping-model": "對應模型",
  "dialog.openwiki.job.running": "產生中",
  "dialog.openwiki.job.writing": "寫入檔案",
  "dialog.openwiki.job.completed": "已完成",
  "dialog.openwiki.job.failed": "失敗",
  "dialog.openwiki.job.cancelled": "已取消",
  "dialog.openwiki.driveRootWarning": "目前工作區看起來是磁碟根目錄。請先開啟具體專案資料夾再產生。",
  "dialog.openwiki.action.generating": "產生中…",
  "dialog.openwiki.action.updating": "更新中…",
